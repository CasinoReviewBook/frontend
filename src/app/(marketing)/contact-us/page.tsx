...
export default function ContactPage() {
      ...
      <section className="py-10 ">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 bg-white border border-gray-200/90 rounded-3xl p-8 sm:p-10 shadow-sm">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full h-12 rounded-xl bg-[#2E68FB] hover:bg-[#2556D6] text-white font-bold text-sm flex items-center justify-center gap-2 transition shadow-md shadow-blue-500/20 active:scale-95"
                >
          ...
          <div className="lg:col-span-5 space-y-6">
            {/* Player Dispute Box */}
            <div className="p-6 sm:p-8 rounded-3xl bg-amber-50/70 border border-amber-200/80 text-[#0F172A] space-y-4">
  ...
  <div className="space-y-3 text-xs text-[#64748B]">
    ...
    <div className="flex justify-between items-center pb-2.5 border-b border-gray-100">
      <div>
        <span className="font-bold text-[#0F172A] block">Asia-Pacific</span>
        <span className="text-[11px] text-gray-400">SGT / AEST (Singapore, Sydney)</span>
      </div>
      <span className="font-mono font-semibold text-[#0F172A] bg-blue-50/60 text-[#2E68FB] px-2.5 py-1 rounded-md border border-blue-100">
        09:00 – 18:00 SGT
      </span>
    ...
    <div className="flex justify-between items-center pb-2.5 border-b border-gray-100">
      <div>
        <span className="font-bold text-[#0F172A] block">Latin America</span>
        <span className="text-[11px] text-gray-400">BRT / ART (São Paulo, Buenos Aires)</span>
      </div>
      <span className="font-mono font-semibold text-[#0F172A] bg-blue-50/60 text-[#2E68FB] px-2.5 py-1 rounded-md border border-blue-100">
        09:00 – 18:00 BRT
      </span>
